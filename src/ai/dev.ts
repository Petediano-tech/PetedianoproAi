...
import '@/ai/flows/generate-original-pictures.ts';
import '@/ai/flows/get-motivational-quote.ts';
...
import '@/ai/flows/generate-video-script.ts'; // Added new flow
import '@/ai/flows/generate-blog-post.ts'; // Added new flow
