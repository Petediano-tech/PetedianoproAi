    ...
    <div className="container mx-auto py-8">
      <Card className="mb-8">
        <CardHeader>
          ...
          <CardDescription>Generate slide-by-slide outlines for presentations with suggested text and visual ideas.</CardDescription>
        </CardHeader>
      </Card>
      ...
      <Card>
        <CardContent className="pt-6 text-center min-h-[400px] flex flex-col items-center justify-center">
          ...
          <p className="text-muted-foreground max-w-md">
            The AI Presentation Generator is currently being developed and will be available soon. 
