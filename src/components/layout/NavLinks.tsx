...
const navItems = [
  ...
  { href: '/photo-editor', label: 'Photo Editor', icon: Edit3 },
  {
    ...
    subItems: [
      ...
      { href: '/content-generator/recipe-generator', label: 'Recipe Generator', icon: UtensilsCrossed },
      { href: '/content-generator/image-caption-generator', label: 'Image Captions', icon: Captions },
    ],
  },
  ...
  { href: '/assistant', label: 'PeteAI Assistant', icon: Bot },
  {
    ...
    subItems: [
      ...
      { href: '/specialized-ai/business-name-generator', label: 'Business Names', icon: Briefcase },
      { href: '/specialized-ai/trip-planner', label: 'Trip Planner', icon: Map },
      { href: '/specialized-ai/code-explainer', label: 'Code Explainer', icon: Code },
    ],
  },
